...
(function() {
  ...
  Chosen = (function(_super) {
    ...
    Chosen.prototype.results_show = function() {
	  ...
	  if (!this.customButtonsAdded) {
		  this.customButtonsAdded = true;
		  var $dropdown = $(this.dropdown);
		  var $field = $(this.form_field);
        ...
        var opts = this.options || {},
            ...
            selectAllText = opts.select_all_text || 'Select all',
            selectNoneText = opts.uncheck_all_text || 'Deselect all';
        if(this.is_multiple && optionsCount >= showBtnsTresshold) {
			...
			selectAllEl.appendChild(document.createTextNode(' | '));
