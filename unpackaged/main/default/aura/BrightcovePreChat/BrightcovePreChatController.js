({
    ...
    onInit: function(cmp, evt, hlp) {
        ...
        console.log("GC **** prechatFields: ", prechatFields);
        var container = cmp.find("prechatContent");
        ...
        $A.util.addClass(container, "no-phone");
    },
    ...
    handleToggleChange: function(cmp, evt, hlp) {
        var container = cmp.find("prechatContent");
        var input = document.getElementsByClassName("phone");
        
        $A.util.toggleClass(container, "no-phone");
        console.log(input);
        input.value = "";
        console.log(input);
    }
